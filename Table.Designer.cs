namespace RMS
{
    partial class Table
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_request_table = new Button();
            lbl_quantity = new Label();
            txt_members = new TextBox();
            lbl_date = new Label();
            lbl_tableid = new Label();
            txt_tableid = new TextBox();
            cb_timeslots = new ComboBox();
            label2 = new Label();
            ...
            btn_tables.Size = new Size(83, 26);
            ...
            btn_signout.Size = new Size(83, 28);
            ...
            label1.TabIndex = 172;
            label1.Text = "Tables Reservation";
            // 
            // label6
            // 
            ...
            panel2.Name = "panel2";
            panel2.Size = new Size(200, 445);
            panel2.TabIndex = 210;
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Location = new Point(230, 121);
            label3.Name = "label3";
            ...
            // txt_customername
            // 
            txt_customername.Location = new Point(228, 141);
            txt_customername.Name = "txt_customername";
            txt_customername.Size = new Size(211, 23);
            txt_customername.TabIndex = 220;
            // 
            // dataGridView1
            // 
            dataGridView1.BackgroundColor = SystemColors.ActiveCaption;
            dataGridView1.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridView1.Location = new Point(693, 92);
            dataGridView1.Name = "dataGridView1";
            dataGridView1.Size = new Size(255, 328);
            dataGridView1.TabIndex = 219;
            // 
            // dateTimePicker1
            // 
            dateTimePicker1.Location = new Point(226, 237);
            dateTimePicker1.Name = "dateTimePicker1";
            dateTimePicker1.Size = new Size(200, 23);
            dateTimePicker1.TabIndex = 218;
            // 
            // btn_request_table
            // 
            btn_request_table.BackColor = SystemColors.GradientActiveCaption;
            btn_request_table.Cursor = Cursors.Hand;
            btn_request_table.FlatStyle = FlatStyle.Popup;
            btn_request_table.Location = new Point(271, 378);
            btn_request_table.Name = "btn_request_table";
            btn_request_table.Size = new Size(122, 26);
            btn_request_table.TabIndex = 217;
            btn_request_table.Text = "Add Reservation";
            btn_request_table.UseVisualStyleBackColor = false;
            btn_request_table.Click += btn_request_table_Click;
            // 
            // lbl_quantity
            // 
            lbl_quantity.AutoSize = true;
            lbl_quantity.Location = new Point(230, 165);
            lbl_quantity.Name = "lbl_quantity";
            lbl_quantity.Size = new Size(61, 17);
            lbl_quantity.TabIndex = 216;
            lbl_quantity.Text = "Members";
            // 
            // txt_members
            // 
            txt_members.Location = new Point(228, 185);
            txt_members.Name = "txt_members";
            txt_members.Size = new Size(211, 23);
            txt_members.TabIndex = 215;
            // 
            // lbl_date
            // 
            lbl_date.AutoSize = true;
            lbl_date.Location = new Point(230, 216);
            lbl_date.Name = "lbl_date";
            lbl_date.Size = new Size(105, 17);
            lbl_date.TabIndex = 214;
            lbl_date.Text = "Reservation Date";
            // 
            // lbl_tableid
            // 
            lbl_tableid.AutoSize = true;
            lbl_tableid.Location = new Point(230, 73);
            lbl_tableid.Name = "lbl_tableid";
            lbl_tableid.Size = new Size(54, 17);
            lbl_tableid.TabIndex = 213;
            lbl_tableid.Text = "Table ID";
            // 
            // txt_tableid
            // 
            txt_tableid.Location = new Point(226, 94);
            txt_tableid.Name = "txt_tableid";
            txt_tableid.Size = new Size(211, 23);
            txt_tableid.TabIndex = 212;
            // 
            // cb_timeslots
            // 
            cb_timeslots.FormattingEnabled = true;
            cb_timeslots.Location = new Point(226, 287);
            cb_timeslots.Name = "cb_timeslots";
            cb_timeslots.Size = new Size(228, 25);
            cb_timeslots.TabIndex = 223;
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Location = new Point(230, 264);
            label2.Name = "label2";
            label2.Size = new Size(106, 17);
            label2.TabIndex = 222;
            label2.Text = "Reservation Time";
            // 
            // Table
            // 
            AutoScaleDimensions = new SizeF(7F, 17F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(964, 445);
            Controls.Add(cb_timeslots);
            Controls.Add(label2);
            Controls.Add(label3);
            Controls.Add(txt_customername);
            Controls.Add(dataGridView1);
            Controls.Add(dateTimePicker1);
            Controls.Add(btn_request_table);
            Controls.Add(lbl_quantity);
            Controls.Add(txt_members);
            Controls.Add(lbl_date);
            Controls.Add(lbl_tableid);
            Controls.Add(txt_tableid);
            Controls.Add(panel1);
            Controls.Add(panel2);
            Font = new Font("Microsoft New Tai Lue", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Name = "Table";
        ...
        private Button btn_request_table;
        private Label lbl_quantity;
        private TextBox txt_members;
        private Label lbl_date;
        private Label lbl_tableid;
        private TextBox txt_tableid;
        private ComboBox cb_timeslots;
